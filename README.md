...
> **Pre-1.0** · stable **v0.9.0** · `pip install aiswmm==0.9.0` · [CHANGELOG](CHANGELOG.md)
...
<p>
  ...
  <a href="https://github.com/Zhonghao1995/agentic-swmm-workflow/releases/latest"><img src="https://img.shields.io/badge/release-v0.9.0-1F6FEB" alt="latest release v0.9.0" /></a>
</p>
...
Reproducible run (pinned Docker image, v0.9.0), no local install:
...
| **Agentic SWMM** *(this repository)* | **SWMM engine:** verification-first EPA SWMM automation (Skills + MCP + deterministic runs + audit) | Stable v0.9.0 |
