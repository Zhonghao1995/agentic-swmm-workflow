...
const Args = z.object({
  ...
  rainKind: z.enum(["intensity_mm_per_hr", "depth_mm_per_dt"]).default("depth_mm_per_dt"),
    ...
    tools: [
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            rainKind: { type: "string", enum: ["intensity_mm_per_hr", "depth_mm_per_dt"], default: "depth_mm_per_dt" },
