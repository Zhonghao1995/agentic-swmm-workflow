...
6. `swmm-runner`
7. QA checks
8. `swmm-design-review` (reference-free plausibility review — no observed data needed)
9. optional `swmm-plot`
10. optional `swmm-calibration`
...
2. `swmm-runner`
3. QA checks
4. `swmm-design-review` (reference-free plausibility review)
5. optional plotting / calibration
6. optional uncertainty / LID scenario analysis
7. `swmm-experiment-audit`
