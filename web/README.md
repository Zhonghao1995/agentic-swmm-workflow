...
For development, the scripts default to `main`. For public use, prefer pinning `AISWMM_INSTALL_REF` to a released tag such as `v0.6.1` so users get a reproducible installer.
